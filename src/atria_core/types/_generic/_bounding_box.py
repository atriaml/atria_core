...
def as_bbox_array(value: object) -> FloatArray:
...
def check_bbox_array(value: FloatArray) -> None:
...
def as_segmentation_array(value: object) -> FloatArray:
...
def check_segmentation_array(value: FloatArray) -> None:
